...
class ControllerMixinView extends ControllerMixin{
  ...
  constructor(client, layout='layout/default', placeHolder = 'main', themePath= null, viewClass = View.defaultViewClass) {
    ...
    this.exports = {
      ...
      setTemplate      : (file, data= {}) => (this.template      = (typeof file === 'string') ? this.getView(file, data, themePath, viewClass) : file),
      setLayout        : (file, data= {}) => (this.layout        = (typeof file === 'string') ? this.getView(file, data, themePath, viewClass) : file),
      setErrorTemplate : (file, data= {}) => (this.errorTemplate = (typeof file === 'string') ? this.getView(file, data, themePath, viewClass) : file),
